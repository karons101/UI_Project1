...
country of birth, laboratory information, clinical information, test results, name of doctor that attended to the patient. 
  ...
  This webapp system Users are Medical doctors from various medical descipline and patiants with various medical
 status, background and condition.


 Pages Dependencies: From the login page the user can register and after registration the user gets 
a home page which holds four medical report forms and can be updated and can be submitted. 

The USER Story: 
New User can register to get an account and can login to its dashboard(Account) while a patient can schedule to see a doctor and a doctor has 
access to patients medical details, records and history..
The User has a unique ID upon registration and gets an animated username on dashborad and has access to various online
forms for medical record purspose, the user has a navigation bar to seamlessly navigate through out the application
and can logout from the dashboard. 



VIDEO DEMO FOR PROJECT DELIVERABLE 1 AND 2
https://www.youtube.com/watch?v=-rwY5dOC7dg
